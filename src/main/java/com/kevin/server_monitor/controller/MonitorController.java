...
import com.kevin.server_monitor.common.ServerString;
import com.kevin.server_monitor.security.service.UserService;
import com.kevin.server_monitor.security.vo.UserVo;
import com.kevin.server_monitor.service.MonitorService;
import com.kevin.server_monitor.utill.RankingUtils;
import com.kevin.server_monitor.utill.SSHUtils;
...
public class MonitorController {
    ...
    static Logger logger = LoggerFactory.getLogger(MonitorController.class);
    static List<Map<String, Object>> returnList = new ArrayList<>();
    private final UserService userService;
    private final MonitorService monitorService;

    public MonitorController(UserService userService, MonitorService monitorService) {
        this.userService = userService;
        this.monitorService = monitorService;
    }

    public static void serverinformation(String server) {
        String result;
    ...
    public ModelAndView getMonitoring(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (power.equals("on")) {
                ...
                if (resultStr.contains("Tomcat started.")) {
                    result = "ok";
                } else if (resultStr.contains("Start aborted.")) {
                    result = "reason";
                } else {
                    result = "nok";
                }
